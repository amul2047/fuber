						...
						<table id="example2"
							...
							<thead>
								<tr role="row">
									...
									<th class="sorting_asc" tabindex="0" aria-controls="example2"
										rowspan="1" colspan="1" aria-sort="ascending"
										aria-label="Rendering engine: activate to sort column descending">User Story
									</th>
							...
							<c:forEach items="${UserStoryList}" var="userStory" varStatus="loopCounter">
								...
								<tr role="row" class="odd">
									...
									<td><a><c:out value="${userStory.name}" /></a></td>
									<!--<td><c:out value="${userStory.description}" /></td>-->
									<td>
										<button class="btn btn-success" onclick="editProductbacklog(${userStory.id});">
			...
			<div class="modal-content">
				...
				<c:url var="actionUrl" value="saveProductBacklog" /><br><br>
                  ...
                  <div class="box-body">
                    ...
                    <textarea path ="name" name="name" class="form-control" id="description" placeholder="Enter User Story Description"> </textarea>
