				...
				<div class="row">
					<div class="col-sm-12">
						<table id="example2"
							...
							<tbody>
							<c:forEach items="${UserStoryList}" var="UserStory" varStatus="loopCounter">
								...
								<tr role="row" class="odd">
									...
									<td>
										<button class="btn btn-success" onclick="editUserStory(${UserStory.id});">
											<i class="fa fa-pencil"></i> Edit
										</button> <a class="btn btn-danger"
										onclick="return confirm('Are you sure you want to delete this User Story?');"
										href="delete/${UserStory.id}"> <i class="fa fa-times"></i>Delete
									</a>
									</td>
								</tr>
							</c:forEach>
	...
	<div class="modal fade" id="addUserStoryModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<c:url var="actionUrl" value="saveUserStory" /><br><br>
