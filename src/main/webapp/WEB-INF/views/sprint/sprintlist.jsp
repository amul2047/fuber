				...
				<div class="row">
					<div class="col-sm-12">
						<table id="example2"
							...
							<tbody>
							<c:forEach items="${SprintList}" var="Sprint" varStatus="loopCounter">
								...
								<tr role="row" class="odd">
									...
									<td>
										<button class="btn btn-success" onclick="editUserStory(${Sprint.id});">
											<i class="fa fa-pencil"></i> Edit
										</button> <a class="btn btn-danger"
										onclick="return confirm('Are you sure you want to delete this User Story?');"
										href="../../sprint/delete/${Sprint.id}"> <i class="fa fa-times"></i>Delete
									</a>
									<a class="btn btn-info"
												href="../../sprint/userstory/${releaseBacklogId}/${Sprint.id}/">
													<i class="fa fa-minus"></i>Story
											</a>
									</td>
								</tr>
							</c:forEach>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Add Sprint</h4>
				</div>
				<div class="modal-body">
				<c:url var="actionUrl" value="saveSprint" /><br><br>
			
				  <form action="${actionUrl }" commandName="book" role="form" id="modalForm" method="post">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Description</label>
                      <textarea path ="description" name="description" class="form-control" id="description" placeholder="Enter  Description"> </textarea>
                    </div>
				...
				<div class="modal-footer">
					...
					<button type="button" id="saveSprint" class="btn btn-primary">Save</button>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	function editUserStory(id)
	{
		...
		$.get("/mumscrum/sprint/get/" + id, function(result) {	
			
			$("#id").val(result.sprint.id);	
			$("#description").val(result.sprint.description);
			$("#addSprintModal").modal('show');
