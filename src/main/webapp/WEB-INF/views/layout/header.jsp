...
<html>
  <head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" type="text/css" href='<c:url value="/web-resources/dist/css/AdminLTE.min.css"/>'>

    <!-- AdminLTE Skins. Choose a skin from the css/skins 
         folder instead of downloading all of them to reduce the load. -->
	<link rel="stylesheet" type="text/css" href='<c:url value="/web-resources/dist/css/skins/_all-skins.min.css"/>'>
  ...
  <body class="skin-blue fixed sidebar-mini">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
          ...
          <span class="logo-mini"><b>FU</b>BER</span>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li>
              <a href="<c:url value="/feeder/"/>">
                <i class="fa fa-th"></i> <span>Nearest Feeders</span>
              </a>
            </li>
            <li>
    ...
    <!--         
       ...
       --> 
            ...
            <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Sales Report</span></a></li>
          </ul>
