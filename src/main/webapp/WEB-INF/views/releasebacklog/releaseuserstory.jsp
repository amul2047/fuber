	...
	<section class="content">
		...
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Add User Story to Release</h3>
			</div>
			<!-- /.box-header -->


			<div class="box-body">
				<form:select id="assignToRelease"  path="UserStory" class="form-control" >
<%-- 					<form:options items="${UnassignedStoryList}" /> --%>
    	...
    	<input type="hidden" name="releasebacklogId" id = "releasebacklogId" value = "${releasebacklogId}"/>
				</form:select>
        ...
        <option value="${UserStory.name}">
            ${UserStory.name}
				...
				<br>
			<button class="pure-button pure-button-primary btn btn-primary" onclick="addToRelease()">
				<i class="fa fa-plus"></i>Add to Release
			</button>
										...
										<tr role="row" class="odd">
											...
											<td>
												<%-- <button class="btn btn-success"
													...
													href="delete/${releasebacklogId}/${UserStory.id}"> <i class="fa fa-times"></i>Remove from Release
											</a>
											</td>
										</tr>
									</c:forEach>
...
<script type="text/javascript">
	...
	{
		var userstoryId = document.getElementById("assignToRelease");
		var releasebacklogId =  document.getElementById("releasebacklogId").value;
		var ctx = "<%=request.getContextPath()%>" 
		window.location.href = ctx + "/releasebacklog/addToRelease/"+releasebacklogId +"/"+ userstoryId.options[userstoryId.selectedIndex].value  ;
