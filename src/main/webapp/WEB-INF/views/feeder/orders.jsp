				...
				<div class="row">
					<div class="col-sm-12">
						<table id="example2"
							...
							<c:forEach items="${orderList}" var="Order" varStatus="loopCounter">
								<tr role="row" class="odd" id="row-${loopCounter}">
								</tr>
								<tr role="row" class="odd">
									<td class="sorting_1"><c:out value="${loopCounter.count}" /></td>
									<td><c:out value="Order ${loopCounter.count}" /></td>
									<td>
										<button class="btn btn-success" onclick="viewDetails(${Order.id});">
...
<script type="text/javascript">
	...
	function viewDetails(orderId)
	{
		...
		window.location.href ="/fuber/order/details/" + orderId;
